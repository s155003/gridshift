...
> charging, done by morning. Shifted, that is **[X]% less CO₂**, about
...
> **negative 0.88**, meaning following our advice emitted *more* CO₂ than doing nothing.
>
...
> "Twelve months of real grid data. Chronological train, validation and test split,
...
3. Region switched to CAISO, amber `transferred` badge appearing
...
- **"How do you know the transfer works?"** We do not, and we say so. The physics

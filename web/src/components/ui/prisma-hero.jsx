/* From 21st.dev, converted TSX to JSX for this project.
 *
 * WordsPullUp and WordsPullUpMultiStyle are the reusable parts and are used by
 * GridShift's hero. PrismaHero itself is the demo shell it shipped in: a
 * creative-agency landing page with its own navbar, branding and copy. It is
 * kept here unmodified for reference and is deliberately not mounted, for
 * reasons recorded in DESIGN-EXCEPTIONS.md section 5.
 */
...
/* ---------------- PrismaHero (reference only, not mounted) ---------------- */
